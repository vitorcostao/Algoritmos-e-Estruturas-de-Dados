...
class Hash {
    ...
    // Função que calcula soma dos caracteres ASCII
    ...
    // Função que retorna comparacoes
    ...
    public int reh(String nome) {
        return (ascii(nome) + 1) % m;
    }

    // Inserção com hash e rehash
    ...
    // Pesquisa com impressão no formato exigido
    public void pesquisar(String nome) {
        ...
        if (tabela[pos] != null && tabela[pos].equals(nome)) {
            ...
            if (tabela[posRehash] != null && tabela[posRehash].equals(nome)) {
                comparacoes++;
...
public class Q06 {
     ...
     public static void main(String[] args) throws Exception {
        ...
        while(!entrada1.equals("FIM")){
            ...
            hash.inserir(Show.AddVetor("/tmp/disneyplus.csv", entrada1).getTitle());
            entrada1 = MyIO.readLine();
        }
