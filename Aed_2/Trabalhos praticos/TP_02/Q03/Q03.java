...
class ResultadoPesquisa {
    ...
    ResultadoPesquisa(boolean encontrado, int comparacoes) {
...
class Show {
    ...
    /**
     * Pesquisa sequencial no vetor de shows usando o título como chave.
     * 
     * @param shows   Vetor de Shows
     * @param tamanho Quantidade de elementos válidos no vetor
     * @param chave   Título a ser pesquisado
     * @return ResultadoPesquisa contendo se encontrou e quantas comparações foram
     *         feitas
     */
    public static ResultadoPesquisa pesquisaSequencial(Show[] shows, int tamanho, String chave) {
        ...
        for (int i = 0; i < tamanho; i++) {
            ...
            if (shows[i] != null && shows[i].getTitle().equals(chave)) {
                
                return new ResultadoPesquisa(true, comparacoes);
            }
        }

        return new ResultadoPesquisa(false, comparacoes);
    }
}
...
public class Q03 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Acumulador de comparações
        int totalComparacoes = 0;

        entrada2 = MyIO.readLine();

        while (!entrada2.equals("FIM")) {
            ResultadoPesquisa resultado = Show.pesquisaSequencial(shows, i, entrada2);
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("1521300_sequencial.txt"))) {
