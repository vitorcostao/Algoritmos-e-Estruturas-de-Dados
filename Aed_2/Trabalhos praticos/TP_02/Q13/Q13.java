...
class Show {
     ...
     * @param contador Objeto de contador para comparações
     */
    public static void MergeSort(Show[] array, int esq, int dir, Contador contador) {

        // Ordenação
        if (esq < dir) {
            int meio = (esq + dir) / 2;
            MergeSort(array, esq, meio, contador);
            MergeSort(array, meio + 1, dir, contador);
            Intercalar(array, esq, meio, dir, contador);
        }
    }

    public static void Intercalar(Show[] array, int esq, int meio, int dir, Contador comp) {
        ...
        while (i < n1 && j < n2) {
            ...
            comp.incrementar();
            int cmp = a1[i].getDuration().compareTo(a2[j].getDuration());
            
            if (cmp < 0 || (cmp == 0 && a1[i].getTitle().compareToIgnoreCase(a2[j].getTitle()) < 0)) {
...
public class Q13 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Ordenação
        Show.MergeSort(shows, 0, shows.length - 1, contador);
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("1521300_MergeSort.txt"))) {
