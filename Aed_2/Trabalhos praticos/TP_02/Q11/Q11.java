...
class Show {
     ...
     */
    public static int getMaior(Show[] array, Contador contador) {
    ...
    public static void CountingSort(Show[] array, Contador contador) {

        // Definir dados
        int tam = array.length;
        int n = getMaior(array, contador);
        ...
        // Procura posições dos shows com anos iguais
        int inicio = 0;
        while (inicio < tam) {

            // Calcula posições
            int anoAtual = ordenado[inicio].getReleaseYear();
            int fim = inicio + 1;

            contador.incrementar();
            while (fim < tam && ordenado[fim].getReleaseYear() == anoAtual) {
            ...
            if (fim - inicio > 1) {
                ...
                insertionSortPorTitulo(ordenado, inicio, fim - 1, contador);
            }
    ...
    /**
     * Ordenação InsertionSort para Títulos
     * 
     * @param array
     * @param inicio
     * @param fim
     * @param contador
     */
    public static void insertionSortPorTitulo(Show[] array, int inicio, int fim, Contador contador) {
        ...
        for (int i = inicio + 1; i <= fim; i++) {
            ...
            contador.incrementar();
            while (j >= inicio && array[j].getTitle().compareTo(atual.getTitle()) > 0) {
...
public class Q11 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Ordenação
        Show.CountingSort(shows, contador);
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("1521300_countingsort.txt"))) {
