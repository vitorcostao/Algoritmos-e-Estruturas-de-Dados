...
/**
 * Classe de arquivo com tipos genéricos implementando interface de entidades
 * 
 */
public class Arquivo<T extends Entidade> {

    // Definir dados
    RandomAccessFile arquivo; // Ponteiro arquivos
    HashExtensivel<ParIDEndereco> indiceDireto; // Tabela hash 
    String nomeArquivo; // Nome do arquivo
    int TAM_CABECALHO = 12; // Tamanho do cabeçalho
    Constructor<T> construtor; // Classe de construtor para tipos genéricos
    ...
    /**
     * Função para criar dados em arquivo
     * @param entidade Nova entidade
     * @return Inteiro
     * @throws Exception Tratamento de dados
     */
